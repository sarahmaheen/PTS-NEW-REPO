...
return (
  <div className="therapy-dashboard-container p-4 sm:p-6 bg-gray-100 min-h-screen font-mono">
                ...
                <button
                  ...
                  className={`date-button px-3 py-2 rounded-md transition-colors duration-300 ease-in-out ${
                    ...
                    selectedDate.getFullYear() === date.getFullYear()
                      ? 'bg-[#29A167] text-white' // Change to green when selected
                      : 'bg-gray-200 hover:bg-[#29A167] hover:text-white' // Change hover to green
                  }`}
                  onClick={() => handleCalendarClick(date)}
                >
    ...
    <div className="details-container flex flex-col md:flex-row justify-between mb-6 space-y-4 md:space-y-0 md:space-x-4">
      {/* Patient Details Section */}
      {patientDetails && (
        <div className="patient-details-container flex-1 p-4 bg-[#CB6BE5] text-black shadow-md rounded-md transition-shadow duration-300 ease-in-out hover:shadow-lg max-w-sm mx-auto">
          ...
          <p className="patient-details-info">
            Starting Date: {new Date(patientDetails.firstLoginDate).toLocaleDateString()}
          </p>
          <p className="patient-details-info">
            Therapy Completed Days: {patientDetails.therapyCompletedDays}
          </p>
      ...
      {/* Display Selected Therapy Details */}
      {selectedTherapy ? (
        <div className="therapy-details-container flex-1 p-4 bg-[#CB6BE5] text-black shadow-md rounded-md transition-shadow duration-300 ease-in-out hover:shadow-lg max-w-sm mx-auto">
          ...
          <div className="tab-container flex flex-col sm:flex-row justify-between space-y-2 sm:space-y-0 mb-6">
            <button
              className={`tab-button py-2 px-4 sm:px-6 rounded-md transition-all duration-300 ease-in-out ${
                activeTab === 'observations'
                  ? 'bg-[#29A167] text-white shadow-lg' // Change to green when active
                  : 'bg-gray-200 hover:bg-[#29A167] hover:text-white'
              }`}
              onClick={() => toggleTab('observations')}
            >
              Observations
